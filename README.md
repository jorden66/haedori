...
+~~Developer By : @HaedoRI On Telegram ,
...
git clone https://github.com/jorden66/haedori.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf haedori && rm -rf .telegram-cli && git clone https://github.com/jorden66/haedori.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
